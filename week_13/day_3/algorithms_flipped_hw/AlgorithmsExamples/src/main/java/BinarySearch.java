...
public class BinarySearch {
    public static Boolean searchArrayList(int search_number, ArrayList<Integer> array){
        ...
        ArrayList<Integer> new_search_area;

        if (search_number < midpoint)  {
            new_search_area = new ArrayList<Integer>(array.subList(0, middle_index-1));
        } else {
            new_search_area = new ArrayList<Integer>(array.subList(middle_index + 1, array.size()));
        }
